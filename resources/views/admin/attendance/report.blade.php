...
@section('style')
    ...
    <style>
        ...
        .sticky-column + .sticky-column {
            left: 100px; /* This should be the width of the first sticky column */
        }
                            ...
                            <div class="modal fade" id="AddModalPlan" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{route('admin.attendance-comment-add')}}">
                                            @csrf
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input class="form-control" type="hidden" name="student_id" id="student_id">
                                                    <input class="form-control" type="hidden" name="attendance_date" id="attendance_date">
                                                    <label style="font-weight: bold;">Залгасан эсэх</label>
                                                    <select name="contact_status" id="contact_status" class="form-control">
                                                        <option value="contacted">Холбогдсон</option>
                                                        <option value="unable_to_reach">Холбогдох боломжгүй</option>
                                                        <option value="to_be_contacted">Холбогдоогүй</option>
                                                    </select>
                    ...
                    <div class="card-body">
                        ...
                        <div class="scrollable-table-wrapper">
                            <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                                ...
                                <tr>
                                    <th>ID</th>
                                    <th class="sticky-column">Сурагчид</th>
                                    <th class="sticky-column">Утас</th>
                                ...
                                @foreach ($students as $key=>$student)
                                    <tr>
                                        ...
                                        <td class="sticky-column"><span></span> {{ $student->userDetails->lastname }} {{ $student->userDetails->firstname }} {{$student->userDetails->registration_number}}</td>
                                        <td class="sticky-column">{{ $student->userDetails->phone_number_1 }} {{ $student->userDetails->phone_number_2 }} {{ $student->userDetails->phone_number_3 }} {{ $student->userDetails->guardian_phone_number }} </td>
                                        @foreach ($dates as $date)
                                            @php
                                                ...
                                                @if ($attendance)
                                                    @switch($attendance->attendance_type)
                                                        @case(1)
                                                            ...
                                                            @endif
                                                            <span class="svg-icon svg-icon-danger svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan">
                                                        ...
                                                        @case(2)
                                                            @if ($attendance->comment)
                                                                <span class="marker"></span>
                                                            @endif
                                                            <span class="svg-icon svg-icon-success svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                     width="24px" height="24px" viewBox="0 0 24 24"
                                                                     version="1.1" >
                                                        ...
                                                        @case(3)
                                                            @if ($attendance->comment)
                                                                <span class="marker"></span>
                                                            @endif
                                                            <span class="svg-icon svg-icon-warning svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                     width="24px" height="24px" viewBox="0 0 24 24"
                                                                     version="1.1">
                                                        ...
                                                        @case(4)
                                                            @if ($attendance->comment)
                                                                <span class="marker"></span>
                                                            @endif
                                                            <span class="svg-icon svg-icon-info svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                     width="24px" height="24px" viewBox="0 0 24 24"
                                                                     version="1.1">
                                                        ...
                                                        @case(5)
                                                            ...
                                                            <span class="svg-icon svg-icon-primary svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                     width="24px" height="24px" viewBox="0 0 24 24"
                                                                     version="1.1">
                                                        ...
                                                        @case(6)
                                                            @if ($attendance->comment)
                                                                <span class="marker"></span>
                                                            @endif
                                                            <span class="svg-icon svg-icon-primary svg-icon-2x" data-student-id="{{ $student->id }}" data-attendance-date="{{ $date }}" data-toggle="modal" data-target="#AddModalPlan"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Devices\Router2.svg--><svg
    ...
    <script>
        $(document).ready(function () {
            $('.svg-icon').click(function () {
                ...
                $.ajax({
                    url: "{{ route('fetch.student.attendance') }}",
                    type: 'GET',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        $('#contact_status').find('option').each(function () {
                            console.log("hha");
    ...
    <script>
        var KTSelect2 = function () {
            ...
            var modalDemos = function () {
                $('#class_id_modal').on('shown.bs.modal', function () {
                    // basic
                    $('#class_id_modal').select2({
                        placeholder: "Анги сонгоно уу"
                    });
                });
            }
