                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Student News</h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{route('admin.student.news-create')}}" class="btn btn-primary font-weight-bolder">
                                <i class="la la-plus"></i>Create News</a>
                            <!--end::Button-->
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            <tr>
                                ...
                                <th>Гарчиг</th>
                                <th>Тайлбар</th>
                                <th>Created Date bn</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($studentNews as $item)
                                <tr>
                                    <td>{{$item->id}}</td>
                                    <td>{{$item->title}}</td>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/student/news/edit/'.$item->id) }}"
                                           class="btn btn-sm btn-clean btn-icon" title="edit">
                                            <i class="la la-edit"></i>
                                        </a>

                                        <a href="{{ url('admin/student/news/delete/'.$item->id) }}"
