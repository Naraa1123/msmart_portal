                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Special News</h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{route('admin.special.news-create')}}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            @foreach($specialNews as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/special/news/edit/'.$item->id) }}"
                                            class="btn btn-sm btn-clean btn-icon" title="edit">
                                            <i class="la la-edit"></i>
                                        </a>

                                        <a href="{{ url('admin/special/news/delete/'.$item->id) }}"
