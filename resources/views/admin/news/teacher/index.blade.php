                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Teacher News</h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{route('admin.teacher.news-create')}}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            @foreach($teacherNews as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/teacher/news/edit/'.$item->id) }}"
                                            class="btn btn-sm btn-clean btn-icon" title="edit">
                                            <i class="la la-edit"></i>
                                        </a>

                                        <a href="{{ url('admin/teacher/news/delete/'.$item->id) }}"
