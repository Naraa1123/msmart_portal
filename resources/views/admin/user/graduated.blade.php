    ...
    <script>
        $(document).ready(function () {
            ...
            $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
                ...
                var role = data[1]; // Adjust index based on your table
            ...
            $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
                ...
                var className = data[3]; // Adjust index based on your table
            ...
            $('#filterDepartment, #filterRole, #filterClass').change(function () {
                table.draw();
            });
        });
