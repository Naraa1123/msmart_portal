                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <span class="card-icon">
                            ...
                            <h3 class="card-label">Уулзалтанд орсон оюутнууд</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            <tbody>
                            @foreach($archived_students as $key=>$item)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    ...
                                    <th> {{ optional($item->user->userDetails)->phone_number_1 ?? '' }},
                                        {{ optional($item->user->userDetails)->phone_number_2 ?? '' }}</th>
...
{{--                                                                <textarea placeholder="Судалгааны нэр бичнэ үү" name="meeting_note"--}}
{{--                                                                          class="form-control"--}}
{{--                                                                          type="text"--}}
{{--                                                                          id="name"--}}
{{--                                                                          required></textarea>--}}
...
{{--                                        </div>--}}
                                        ...
                                        <a href="{{ route('admin.issue-archive-delete', ['id' => encrypt($item->id)]) }}"
