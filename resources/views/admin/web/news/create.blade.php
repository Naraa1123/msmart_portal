        ...
        <div class="col md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/web/news') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="youtube_link_1" class="form-control" value="{{old('youtube_link_1')}}" >
                                </div>

                                <div class="mb-3">
                                    <label for="youtube_link_2">Youtube Link 2 (Заавал биш)</label>
                                    <input type="text" name="youtube_link_2" class="form-control" value="{{old('youtube_link_2')}}" >
                                </div>

                                <div class="mb-3">
                                    <label for="status">Status</label>
                                    <input type="checkbox" name="status"> (Checked = Private, Unchecked = Public)
                                </div>
                            ...
                            <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel" aria-labelledby="image-tab" tabindex="0">
                                <div class="mb-3">
                                    <label>Upload News Image</label><br><br>
