...
" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('teacher/css/teacher.css') }}">
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        <!--begin::Aside-->
        @include('layouts.inc.teacher.sidebar')
        <!--end::Aside Menu-->
    </div>
    <!--end::Aside-->
    <!--begin::Wrapper-->
    <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
        <!--begin::Header-->
        @include('layouts.inc.teacher.header')
        <!--end::Header-->
        <!--begin::Content-->
            @yield('content')
        <!--end::Content-->
        <!--begin::Footer-->
        @include('layouts.inc.teacher.footer')
        <!--end::Footer-->
    </div>
    <!--end::Wrapper-->
</div>
...
<!-- begin::User Panel-->
@include('layouts.inc.teacher.navbar')
<!-- end::User Panel-->
